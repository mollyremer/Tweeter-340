...
const handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let request = new tweeter_shared_1.GetFolloweesCountRequest(authToken, user);
    //let request = JSON.parse(JSON.stringify(event));
    console.log(request);
    let response = yield new UserService_1.UserService(DAO).getFolloweesCount(request);
